      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          {!loaded && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-shadow-mid z-20">
              <div
                className="w-10 h-10 rounded-full border-2 border-gold/20 border-t-gold animate-spin mb-4"
              />
          ...
          {/* iframe — replace src with your BlueMap/Dynmap URL */}
          <iframe
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="font-cinzel text-[10px] text-parchment/30 uppercase tracking-wider">
              Live Map
            </span>
          </div>
          <a
