    ...
    <section className="relative py-24 bg-shadow-mid overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="font-garamond italic text-parchment/40 mt-3 text-lg max-w-lg mx-auto">
            Screenshots from the battlefield — add your own images to{' '}
      ...
      >
        {SHOTS.map((shot, i) => (
          ...
          >
            {/* Gradient placeholder — replace with real screenshot */}
            {/* <img src={`/gallery/${shot.id}.jpg`} alt={shot.label} className="absolute inset-0 w-full h-full object-cover" /> */}
            ...
            {/* Hover overlay */}
            <div className="absolute inset-0 bg-shadow/60 opacity-0 group-hover:opacity-100 transition-opacity duration-400 flex flex-col justify-end p-4">
            ...
            <div
              ...
              style={{
                boxShadow: 'inset 0 0 0 1px rgba(201,168,76,0)',
              }}
            />
          </motion.div>
        ))}
